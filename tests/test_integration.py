...
class TestHubbardSystemConfig:
    ...
    def test_basic_initialization(self):
        ...
        cfg = Hubbard_system_config(size=100, t=1.0, U=4.0, sizeA=1, Np=1.0, bc=1)
        assert cfg.size == 100
        assert cfg.t == 1.0
        assert cfg.U == 4.0
        assert cfg.sizeA == 1
    ...
    def test_ntot_is_twice_sizeA(self):
        from dmft_config import Hubbard_system_config
        cfg = Hubbard_system_config(size=100, t=1.0, U=4.0, sizeA=2, Np=1.0, bc=1)
    ...
    def test_epsk_bandwidth(self):
        ...
        from dmft_config import Hubbard_system_config
        t = 1.0
        cfg = Hubbard_system_config(size=1000, t=t, U=4.0, sizeA=1, Np=1.0, bc=1)
