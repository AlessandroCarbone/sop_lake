...
class TestCheckSelfAdjoint:
    ...
    def test_hermitian_matrix(self):
        from src.utils import check_selfadjoint
...
class TestClosestHermitian:
    ...
    def test_projects_to_hermitian(self):
        from src.utils import closest_hermitian
...
class TestIsPosSemidef:
    ...
    def test_positive_definite(self):
        from src.utils import is_pos_semidef
...
class TestClosestPosSemidef:
    ...
    def test_psd_after_projection(self):
        from src.utils import closest_pos_semidef
...
class TestMatsubaraFreq:
    ...
    def test_n_zero(self):
        """ω_0 = π/β."""
        from src.utils import Matsubara_freq
        beta = 100.0
...
class TestNumericalGrad:
    ...
    def test_linear_function(self):
        """∇(a·x) = a."""
        from src.utils import numerical_grad
...
class TestFrequencyAxis:
    ...
    def test_shift_axis_length(self):
        from src.embedding_utils import frequency_axis
...
class TestLinearMixing:
    ...
    def test_alpha_one_returns_list1(self):
        from src.embedding_utils import linear_mixing_lists
        list1 = [1.0, 2.0, 3.0]
        list2 = [4.0, 5.0, 6.0]
...
class TestDOSDiff:
    ...
    def test_identical_greens_functions(self):
        from src.embedding_utils import DOS_diff
        ntot = 2
...
class TestLanczosToSOP:
    ...
    def test_empty_input(self):
        from src.lanczos import lanczos_to_SOP
...
class TestLanczosBasis:
    ...
    def test_lanczos_basis_diagonal_matrix(self):
        ...
        from src.lanczos import lanczos_basis
